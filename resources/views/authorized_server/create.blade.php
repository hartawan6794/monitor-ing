    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control @error('ip_address') is-invalid @enderror" id="form-ip_address" name="ip_address" value="{{ old('ip_address') }}" placeholder="Masukkan ip address">
                @error('ip_address')
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control @error('server_name') is-invalid @enderror" id="form-server_name" name="server_name" value="{{ old('server_name') }}" placeholder="Masukkan server name">
                @error('server_name')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control @error('username') is-invalid @enderror" id="form-username" name="username" value="{{ old('username') }}" placeholder="Masukkan username">
                @error('username')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control @error('password') is-invalid @enderror" id="form-password" name="password" value="{{ old('password') }}" placeholder="Masukkan password">
                @error('password')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control @error('port') is-invalid @enderror" id="form-port" name="port" value="{{ old('port') }}" placeholder="Masukkan port">
                @error('port')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
