...
@section('title', 'Tambah PricingPlan')
...
@section('content')
    ...
    <!-- Form Tambah pricing_plan -->
    <div class="box">
        <div class="box-header justify-between">
            <div class="box-title">
                Input Data pricing_plan
            </div>
        </div>
        <div class="box-body">
              <form action="{{ route('pricing_plan.store') }}" method="POST">
                @csrf
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" id="form-name" name="name" value="{{ old('name') }}" placeholder="Contoh: Basic, Premium, etc.">
                @error('name')
            ...
            <div class="grid grid-cols-12 gap-x-4">
                <div class="col-span-6 mb-4">
                    ...
                    <input type="text" class="form-control @error('price') is-invalid @enderror" id="form-price" name="price" value="{{ old('price') }}" placeholder="Contoh: $19, Free, etc.">
                    @error('price')
                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
                <div class="col-span-6 mb-4">
                    ...
                    <input type="text" class="form-control @error('price_subtext') is-invalid @enderror" id="form-price_subtext" name="price_subtext" value="{{ old('price_subtext') }}" placeholder="Contoh: /per month">
                    @error('price_subtext')
                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
            ...
            <div class="grid grid-cols-12 gap-x-4">
                ...
                <div class="col-span-6 mb-4">
                    ...
                    <input type="text" class="form-control @error('button_link') is-invalid @enderror" id="form-button_link" name="button_link" value="{{ old('button_link') }}" placeholder="Contoh: # / https://...">
                    @error('button_link')
                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
            ...
            <div class="grid grid-cols-12 gap-x-4">
                <div class="col-span-4 mb-4">
                    ...
                    <input type="text" class="form-control @error('badge_text') is-invalid @enderror" id="form-badge_text" name="badge_text" value="{{ old('badge_text') }}" placeholder="Contoh: Most Popular">
                    @error('badge_text')
                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
                <div class="col-span-4 mb-4">
                    ...
                    <input type="number" class="form-control @error('order') is-invalid @enderror" id="form-order" name="order" value="{{ old('order', 0) }}">
                    @error('order')
                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
                <div class="col-span-4 mb-4 flex items-center pt-6">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="is_featured" value="1" id="form-is_featured" {{ old('is_featured') ? 'checked' : '' }}>
                            ...
                            <div class="feature-row grid grid-cols-12 gap-x-4 mb-3 items-center">
                                ...
                                <div class="col-span-3">
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="checkbox" name="features[{{ $index }}][is_highlighted]" value="1" {{ isset($feature['is_highlighted']) ? 'checked' : '' }}>
            ...
            <button class="ti-btn ti-btn-primary-full mt-4" type="submit">Simpan Paket</button>
        </form>
    </div>
</div>
