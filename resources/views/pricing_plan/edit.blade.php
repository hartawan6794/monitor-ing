        ...
        <div class="box-body">
            ...
            <div class="grid grid-cols-12 gap-x-4">
                <div class="col-span-6 mb-4">
                    ...
                    <input type="number" class="form-control @error('duration_days') is-invalid @enderror" id="form-duration_days" name="duration_days" value="{{ old('duration_days', $pricing_plan->duration_days ?? 30) }}" placeholder="Contoh: 30">
                    @error('duration_days')
                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
                <div class="col-span-6 mb-4">
                    ...
                    <input type="number" class="form-control @error('max_databases') is-invalid @enderror" id="form-max_databases" name="max_databases" value="{{ old('max_databases', $pricing_plan->max_databases ?? 1) }}" placeholder="Contoh: 3, 999 untuk unlimited">
                    @error('max_databases')
                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
